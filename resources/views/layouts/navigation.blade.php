                ...
                <div class="absolute inset-x-0 mt-5">
                    <div class="w-[30%] dropdown dropdown-bottom flex flex-wrap items-center justify-center text-base ml-auto mr-auto">
                        <label class="relative w-full">
                            {{-- hanya bisa dipakai di route home --}}
                            @if (Request::is('/'))
                                <form action="{{ route('home') }}" method="get">
                                    <input type="text" name="search" value="{{ request('search') }}" class="px-10 w-full bg-[#fff] border focus-within:border-white border-[#000]/50 " placeholder="Search . . .">
